    ...
    <div>
      <div className="grid grid-cols-2 gap-10">
        ...
        <div className="space-y-3 rounded-lg border bg-accent/40 p-5 text-sm text-muted-foreground">
          ...
          <p>
            Keep your users informed with dynamic, automated emails using Nodemailer and React Email
            for templating:
          </p>
          <ul className="flex flex-col gap-2">
            <li className="flex items-center gap-4">
        ...
        <div className="space-y-3 rounded-lg border bg-accent/40 p-5 text-sm text-muted-foreground">
          ...
          <p>
            Boost user engagement with a real-time AI chat powered by OpenAI, offering personalized
            responses, answering questions, and assisting with content creation, all while providing
